...
class SmileLivingController(http.Controller):
    ...
    def homepage(self, **kwargs):
        """SmileLiving listing page.

        NOTE: This route is implemented as a Python controller (not a Website Page).
        If you want to remove the product listing page, disable the route.
        """
