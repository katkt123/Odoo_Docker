...
class SmileLivingController(http.Controller):
    ...
    # NOTE: Do not keep a controller route on `/smileliving`.
    # Users may create/edit a Website Builder page with the same URL.
    @http.route('/smileliving/listing', type='http', auth='public', website=True)
