...
class SmileLivingShop(WebsiteSale):
    ...
    def _get_shop_domain(self, search_term, category, attribute_value_dict):
        ...
        extra_domain = [
            ...
            ('is_house', '=', True),
            # Keep products aligned with the current website company
    ...
    def _get_search_domain(self, search, category, attrib_values):
        ...
        domain.append(('company_id', '=', website_company.id))
    ...
    def shop(self, page=0, category='', search='', **kwargs):
        ...
        area_stats = request.env['product.template'].sudo().read_group(
            [('is_house', '=', True), ('company_id', 'in', [website_company.id, False]), ('area', '!=', False)],
            ['area:min', 'area:max'],
            []
        )
